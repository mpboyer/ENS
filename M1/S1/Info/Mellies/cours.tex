...
\begin{definition}[Première Version]
	Une catégorie cartésienne fermée est une catégorie cartésienne $\left( \mC, \times, \mathds{1} \right)$ munie pour toute paire d'objets $A, B$ d'un objet $A \Rightarrow B$ et une flèche $eval_{A, B}: A \times (A\Rightarrow B) \to B$
