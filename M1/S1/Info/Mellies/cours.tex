...
\begin{definition}
	...
	\begin{category}[]
		...
		P\ar[dr, "g", rrightarrow] & & Q\ar[dl, "f", rrightarrow]\\
		& N &
	\end{category}
...
\begin{exemple}
	...
	\begin{category}[]
		...
		a(Ib)\ar[dr, "g", rrightarrow] & & (Ia)b\ar[dl, "f", rrightarrow]\\
		& ab &
	\end{category}
	\begin{category}[]
		& \Delta(Ia)\ar["u"', dl]\ar[dr, "v"]&\\
		(Ia)(Ia)\ar[d, "v_{2}", rrightarrow]\ar[r, "v_{1}"] & a(Ia)\ar[d] & \Delta a\ar[dl, rrightarrow]\\
		(Ia)a\ar[r] & aa &
	\end{category}
\end{exemple}
...
\begin{definition}
	...
	\begin{category}
		& & R\ar[dr, "h_{v}"] & &\\
		M\ar[r, "d"] & P\ar[ur, "u"]\ar[dr, "v"]\ar[dd, phantom, "\lozenge"] & & Q\ar[r, "e"] & N\\
		& & S\ar[ur, "h_{u}"] & &
	\end{category}
