...
\NewTcbTheorem[use counter from=définition]{théorème}{Théorème}%
 {colback=blue!5, colframe=blue!35!black, fonttitle=\bfseries}{thm}
\NewTcbTheorem[use counter from=définition]{propositionfr}{Proposition}%
 {colback=black!5!white, colframe=black!10!black, fonttitle=\bfseries}{propo}
\NewTcbTheorem[auto counter, number within=propositionfr]{corollaire}{Corollaire}%
 {colback=blue!5, colframe=blue!20!black, fonttitle=\bfseries}{cor}
\NewTcbTheorem[use counter from=définition]{lemme}{Lemme}%
 {colback=gray!95!black, colframe=black, fonttitle=\bfseries}{lemme}
\NewTcbTheorem[use counter from=définition]{remarque}{Remarque}%
 {colback=white!55!black, colframe=white!5!black, fonttitle=\bfseries}{rem}
