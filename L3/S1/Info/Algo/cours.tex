...
\path[Parametrized Complexity]{Lecture 9 : 21/12}
\section{Complexity}
\subsection{Definitions}
...
% \begin{proposition} 
%     We have : \\
%     % $(G, k)$ is a YES instance if and only if $\left(G\setminus\left\{u\right\}, k - 1\right)$ or $\left(G \setminus \mathcal{N}\left[u\right],\, k - d(u)\right)$ is. 
% \end{proposition}
