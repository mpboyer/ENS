...
\begin{definition}
	...
	Le \define{complexe de Čech} $C\left(\mU\right)$ associé au recouvrement $\mU$ vérifie:
	\begin{itemize}
...
\begin{definition}
	Le \define{complexe de Čech} $\cech\left(V, \alpha\right)$ est le complexe simplicial
